...
extension Reminder {
    static var sampleData = [
        ...
        Reminder(
            title: "Interview new project manager candidate / Interview new project manager candidate", dueDate: Date().addingTimeInterval(60000.0),
